...
const SuccessfulLoginModal = (props) => {

    let navigate = useNavigate();

  return (
    <div className="overlay">
            <form className="form d-flex flex-column shadow-lg p-5 bg-body-tertiary rounded">
                ...
                <div className="d-flex justify-content-center ps-3 pe-3 mb-4">
                    <h4 className="modal-text fs-3">Successful login</h4>
                </div>
